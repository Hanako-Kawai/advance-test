    ...
    <div class="confirm__content">
        ...
        <div class="confirm-table">
            ...
            <tr class="confirm-table__row">
                ...
                <input type="text" name="last-name" value="{{ $contact['last-name'] }}" id="last-name" readonly /><input type="text" name="last-name" value="{{ $contact['first-name'] }}" id="first-name" readonly />
                </td>
            </tr>
            <tr class="confirm-table__row">
